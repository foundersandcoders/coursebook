    ...
    <aside>
      <${Nav}>
        ...
        <${Section} title="SW Developer" url=${url} subpath="course/syllabus/developer">
          ...
          <li><${Link} url=${url} href="/course/syllabus/developer/week13-TFB-design/schedule">W13→TFB: Design</${Link}></li>
          <li><${Link} url=${url} href="/course/syllabus/developer/week14-TFB-build/schedule">W14→TFB: Build</${Link}></li>
          <li><${Link} url=${url} href="/course/syllabus/developer/week15-TFB-build/schedule">W15→TFB: Build</${Link}></li>
        </${Section}>
